# Hetnex — Final Implementation Plan

## Overview
**Hetnex** is a full-stack Next.js B2B global business directory. Dealers can register visiting cards with multiple HSN codes, multiple mobile numbers, and up to 10 card images. The platform includes a **subscription/plan system** with start & end dates and a full **Admin Panel** to manage all data.
**Tagline:** *Connecting Businesses, Empowering Growth*
...
|---|---|---|---|---|---|
| **Free** | Try Hetnex with basic features | ₹0 | 1 | 3 | 2 |
