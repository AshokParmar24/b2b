...
import { Business, HsnEntry } from "@/types";

const HsnEntrySchema = new Schema<HsnEntry>(
  {
...
const BusinessSchema = new Schema<Business & Document>(
  {
...
export default models.Business || model<Business & Document>("Business", BusinessSchema);
